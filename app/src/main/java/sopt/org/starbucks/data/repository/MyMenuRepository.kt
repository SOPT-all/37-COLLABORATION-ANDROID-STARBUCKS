...
import sopt.org.starbucks.data.mapper.toData
...
constructor(
    ...
    suspend fun updateMyMenuOption(menuId: Long, request: OptionItemModel): Result<MyMenuOptionModel> =
        safeApiCall {
            myMenuDataSource
                .updateMyMenuOption(menuId, request.toData())
                .handleApiResponse()
                .getOrThrow()
                .toDomain()
        }
